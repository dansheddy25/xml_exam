 ...
 * 
 */
@WebServiceClient(name = "ReleveWS", targetNamespace = "http://prince.baba/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RELEVEWS_QNAME = new QName("http://prince.baba/", "ReleveWS");
    ...
    public ReleveService getReleveServicePort() {
        return super.getPort(new QName("http://prince.baba/", "ReleveServicePort"), ReleveService.class);
    }
    ...
    public ReleveService getReleveServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://prince.baba/", "ReleveServicePort"), ReleveService.class, features);
    }
